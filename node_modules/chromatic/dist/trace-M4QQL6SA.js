...
var chunkMJSJ2BXB_js = require('./chunk-MJSJ2BXB.js');
...
var c=chunkTKGT252T_js.e(chunk6IZZOM5T_js.D());var{STORYBOOK_BASE_DIR:u,STORYBOOK_CONFIG_DIR:h,WEBPACK_STATS_FILE:k}=process.env;async function B(d){let{flags:t,input:p}=(0, c.default)(`
    ...
    `,{argv:d,description:"Trace utility for TurboSnap",flags:{statsFile:{type:"string",alias:"s",default:k||"storybook-static/preview-stats.json"},storybookBaseDir:{type:"string",alias:"b",default:u||"."},storybookConfigDir:{type:"string",alias:"c",default:h||".storybook"},untraced:{type:"string",alias:"u",isMultiple:!0},mode:{type:"string",alias:"m"}}}),e=chunkMJSJ2BXB_js.E({},{logPrefix:"",logLevel:"info"}),y={log:e,options:{storybookBaseDir:t.storybookBaseDir,storybookConfigDir:t.storybookConfigDir,untraced:t.untraced,traceChanged:t.mode||!0},git:{rootPath:await chunkMJSJ2BXB_js.x({log:e})},storybook:{baseDir:t.storybookBaseDir,configDir:t.storybookConfigDir}},g=await chunkLZXDNZPW_js.a(t.statsFile),i=p.map(o=>o.replace(/^\.\//,"")),r=i.find(o=>chunkMJSJ2BXB_js.$(o));if(r)throw new Error(`Unable to trace package manifest file (${r}) as that would require diffing file contents.`);await chunkMJSJ2BXB_js.ga(y,g,t.statsFile,i);}

exports.main = B;
//# sourceMappingURL=out.js.map
//# sourceMappingURL=trace-M4QQL6SA.js.map
